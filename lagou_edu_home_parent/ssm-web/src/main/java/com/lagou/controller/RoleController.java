...
public class RoleController {
    ...
    public ResponseResult findResourceListByRoleId(Integer roleId){
            List<ResourceCategory> resourceCategoryAndResourceByRoleId = roleService.findResourceCategoryAndResourceByRoleId(roleId);
            return new ResponseResult(true,200,"查询角色资源成功",resourceCategoryAndResourceByRoleId);

    }
    @RequestMapping("/roleContextResource")
    public ResponseResult roleContextResource(@RequestBody RoleResourceVo roleResourceVo){
        roleService.resourceContextRole(roleResourceVo);
        ResponseResult result = new ResponseResult(true, 200, "更新资源成功", null);
        return result;
    }
}
